...
def build_tag_sequences(
    ...
    for code in codes:
        ...
        # path_codes: [root, ..., parent, code_norm]
...
def main() -> None:
    ...
    table = load_ontology_table(args.ontology_csv, norm_fn=default_norm)
    ...
    if args.embed:
        ...
        # 为每层标签生成embedding（兼容 medical_icd.py 命名）
